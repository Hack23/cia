 ...
 */
public final class DeleteAccountResponse extends AbstractResponse {
	 ...
	 */
	public DeleteAccountResponse(final ServiceResult result) {
		super(result);
	}
	 ...
	 *
	 * @param googleAuthVerificationCode the new google auth verification code
	 */
	 ...
	 *
	 * @param googleAuthScratchCodes the new google auth scratch codes
	 */
	 ...
	 *
	 * @param otpAuthTotpURL the new otp auth totp URL
	 */
