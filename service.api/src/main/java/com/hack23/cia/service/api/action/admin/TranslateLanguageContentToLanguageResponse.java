 ...
 */
public final class TranslateLanguageContentToLanguageResponse extends AbstractResponse {
	 ...
	 *            the result
	 */
	public TranslateLanguageContentToLanguageResponse(final ServiceResult result) {
		super(result);
	}
