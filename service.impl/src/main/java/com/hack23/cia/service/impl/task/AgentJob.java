...
public final class AgentJob extends QuartzJobBean implements Serializable {
	...
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		AgentJobHolder.getDataAgentApi().execute(new DataAgentWorkOrder().withOperation(DataAgentOperation.IMPORT).withTarget(DataAgentTarget.MODEL_EXTERNAL_RIKSDAGEN));
	}
