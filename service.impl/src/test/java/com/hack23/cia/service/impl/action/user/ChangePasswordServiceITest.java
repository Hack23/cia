...
/**
 * The Class ChangePasswordServiceITest.
 */
public final class ChangePasswordServiceITest extends AbstractServiceFunctionalIntegrationTest {
	 ...
	 */
	@Test
	public void changePasswordRequestSuccessTest() throws Exception {
		...
		changePasswordRequest.setSessionId(serviceRequest.getSessionId());
	 ...
	 */
	@Test
	public void changePasswordRequestFailureWrongPasswordTest() throws Exception {
		final CreateApplicationSessionRequest createApplicationSesstion = createApplicationSesstionWithRoleAnonymous();
		...
		assertNotNull(EXPECT_A_RESULT, changePasswordResponse);
		assertEquals(EXPECT_SUCCESS,ServiceResult.FAILURE, changePasswordResponse.getResult());

	}

	/**
	 * Change password request failure bad new password test.
	 *
	 * @throws Exception the exception
	 */
	@Test
	public void changePasswordRequestFailureBadNewPasswordTest() throws Exception {
		final CreateApplicationSessionRequest createApplicationSesstion = createApplicationSesstionWithRoleAnonymous();
		...
		changePasswordRequest.setSessionId(serviceRequest.getSessionId());
		changePasswordRequest.setCurrentPassword("Userpassword1!");
		changePasswordRequest.setNewPassword("simple");
		changePasswordRequest.setRepeatNewPassword("simple");
	...
	/**
	 * Change password request failure new password not matching test.
	 *
	 * @throws Exception the exception
	 */
	@Test
	public void changePasswordRequestFailureNewPasswordNotMatchingTest() throws Exception {
		final CreateApplicationSessionRequest createApplicationSesstion = createApplicationSesstionWithRoleAnonymous();
		...
		changePasswordRequest.setCurrentPassword("Userpassword1!");
		changePasswordRequest.setNewPassword("newUserpassword1!");
		changePasswordRequest.setRepeatNewPassword("NewBadUserpassword1!");
	 ...
	 */
	@Test
	public void changePasswordRequestReencryptMFASuccessTest() throws Exception {
		final CreateApplicationSessionRequest createApplicationSesstion = createApplicationSesstionWithRoleAnonymous();
	...
	public void serviceRequestValidationFailureTest() throws Exception {
		...
		assertNotNull(EXPECT_A_RESULT, changePasswordResponse);
		assertEquals(EXPECT_SUCCESS,ServiceResult.FAILURE, changePasswordResponse.getResult());
		assertEquals("sessionId must not be null", changePasswordResponse.getErrorMessage());
	}
