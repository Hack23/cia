...
/**
 * The Class DeleteAccountServiceITest.
 */
public final class DeleteAccountServiceITest extends AbstractServiceFunctionalIntegrationTest {
	...
	public void deleteAccountSuccessTest() throws Exception {
		...
		final DeleteAccountRequest deleteAccountRequest = new DeleteAccountRequest();
		deleteAccountRequest.setSessionId(serviceRequest.getSessionId());
		deleteAccountRequest.setUserpassword("Userpassword1!");

		final ServiceResponse deleteAccountResponse = applicationManager.service(deleteAccountRequest);
	...
	public void serviceRequestValidationFailureTest() throws Exception {
		...
		assertEquals("sessionId must not be null", deleteAccountResponse.getErrorMessage());
	}
