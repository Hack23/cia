 ...
 */
@Component
public final class ParliamentChartsPartyAgePageModContentFactoryImpl extends AbstractParliamentPageModContentFactoryImpl {
	 ...
	 */
	public ParliamentChartsPartyAgePageModContentFactoryImpl() {
		super();
	}
	...
	public boolean matches(final String page, final String parameters) {
		return PageCommandParliamentRankingConstants.COMMAND_CHARTS_PARTY_AGE.matches(page, parameters);
	}
