...
/**
 * The Class ParliamentRankingView.
 */
@Service
@Scope(value = ConfigurableBeanFactory.SCOPE_PROTOTYPE)
@VaadinView(value = ParliamentRankingView.NAME, cached = true)
public final class ParliamentRankingView extends AbstractRankingView {
	...
	/**
	 * Instantiates a new parliament ranking view.
	 *
	 * @param context
	 *            the context
	 */
	public ParliamentRankingView(final ApplicationContext context) {
