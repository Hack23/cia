...
public final class PartyCommitteeRolesPageModContentFactoryImpl extends AbstractPartyPageModContentFactoryImpl {
	...
	public Layout createContent(final String parameters, final MenuBar menuBar, final Panel panel) {
		...
		if (viewRiksdagenParty != null) {
			...
			final Label createHeader2Label = LabelFactory.createHeader2Label(COMMITTEE_ROLES);
			...
			panelContent.setExpandRatio(committeeMemberBeanItemGrid, ContentRatio.GRID);
