...
public final class ParliamentChartsDocumentActivityByTypePageModContentFactoryImpl extends AbstractParliamentPageModContentFactoryImpl {
	...
	public Layout createContent(final String parameters, final MenuBar menuBar, final Panel panel) {
		...
		CardInfoRowUtil.createPageHeader(panel, panelContent,
		    ParliamentViewConstants.DOC_ACTIVITY_TITLE,
		    ParliamentViewConstants.DOC_ACTIVITY_SUBTITLE,
		    ParliamentViewConstants.DOC_ACTIVITY_DESC);
	...
	public boolean matches(final String page, final String parameters) {
		return PageCommandParliamentRankingConstants.COMMAND_DOCUMENT_ACTIVITY.matches(page, parameters);
	}
