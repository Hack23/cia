...
/**
 * The Class MinistryGovernmentBodiesIncomeModContentFactoryImpl.
 */
@Component
public final class MinistryGovernmentBodiesIncomeModContentFactoryImpl extends AbstractMinistryPageModContentFactoryImpl {
	...
	/**
	 * Instantiates a new ministry government bodies income mod content factory
	 * impl.
	 */
	public MinistryGovernmentBodiesIncomeModContentFactoryImpl() {
		super();
	}
	...
	public boolean matches(final String page, final String parameters) {
		return PageCommandMinistryConstants.COMMAND_MINISTRY_GOVERNMENT_BODIES_INCOME.matches(page, parameters);
	}
