...
public final class AdminPortalPageModContentFactoryImpl extends AbstractAdminSystemPageModContentFactoryImpl {
    ...
    public Layout createContent(final String parameters, final MenuBar menuBar, final Panel panel) {
        ...
        if (pageId != null && !pageId.isEmpty()) {
            ...
            if (portal != null) {
                Panel cardPanel = createCardPanel("Portal Details");
                VerticalLayout cardContent = (VerticalLayout) cardPanel.getContent();

                addInfoRowsToLayout(cardContent,
                    new InfoRowItem("Portal Name:", portal.getPortalName(), VaadinIcons.GLOBE_WIRE),
                    new InfoRowItem("Description:", portal.getDescription(), VaadinIcons.FILE_TEXT),
                    new InfoRowItem("Portal Type:", portal.getPortalType().toString(), VaadinIcons.VIEWPORT),
                    new InfoRowItem("Google Map API Key:", portal.getGoogleMapApiKey(), VaadinIcons.KEY)
                );
