 ...
 */
@Component
public final class GovernmentBodyRankingIncomePageModContentFactoryImpl extends AbstractGovernmentBodyRankingPageModContentFactoryImpl {
	 ...
	 * impl.
	 */
	public GovernmentBodyRankingIncomePageModContentFactoryImpl() {
		super();
	}
	...
	public Layout createContent(final String parameters, final MenuBar menuBar, final Panel panel) {
		...
		CardInfoRowUtil.createPageHeader(panel, panelContent, "Government Body Income", "Income Details", "Explore detailed income information for government bodies.");
