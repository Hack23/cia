...
import com.hack23.cia.web.impl.ui.application.views.common.menufactory.api.PageCommandApplicationConstants;
import com.hack23.cia.web.impl.ui.application.views.common.menufactory.api.PageCommandMenuBarConstants;
...
public final class ApplicationMenuItemFactoryImpl extends AbstractMenuItemFactoryImpl implements ApplicationMenuItemFactory {
    ...
    public void createOverviewPage(final VerticalLayout panelContent) {
        ...
        createButtonLink(grid, COMMITTEES_LINK_TEXT, VaadinIcons.GROUP,
            PageCommandMenuBarConstants.COMMAND_COMMITTEES_LINK,
        ...
        createButtonLink(grid, PARTIES_LINK_TEXT, VaadinIcons.USERS,
            PageCommandMenuBarConstants.COMMAND_PARTIES_LINK,
            PARTIES_DESCRIPTION);
        ...
        createButtonLink(grid, POLITICIANS_LINK_TEXT, VaadinIcons.USER,
            PageCommandMenuBarConstants.COMMAND_POLITICIANS_LINK,
            POLITICIANS_DESCRIPTION);
        createButtonLink(grid, SEARCH_DOCUMENTS, VaadinIcons.SEARCH,
            PageCommandApplicationConstants.COMMAND_SEARCH_DOCUMENT,
