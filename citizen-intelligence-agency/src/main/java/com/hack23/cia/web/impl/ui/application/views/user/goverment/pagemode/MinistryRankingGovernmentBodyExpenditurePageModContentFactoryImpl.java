...
/**
 * The Class GovernmentBodyRankingExpenditurePageModContentFactoryImpl.
 */
@Component
public final class MinistryRankingGovernmentBodyExpenditurePageModContentFactoryImpl extends AbstractMinistryRankingPageModContentFactoryImpl {

	/** The Constant GOVERNMENT_BODIES. */
	private static final String GOVERNMENT_BODIES = "Ministry Government body Expenditure";
	...
	/**
	 * Instantiates a new government body ranking expenditure page mod content
	 * factory impl.
	 */
	public MinistryRankingGovernmentBodyExpenditurePageModContentFactoryImpl() {
		super();
	}
	...
	public boolean matches(final String page, final String parameters) {
		return NAME.equals(page) && StringUtils.contains(parameters, MinistryPageMode.GOVERNMENT_BODIES_EXPENDITURE.toString());
	}
