...
/**
 * The Class PartyCoalitionsAgainstAnnualSummaryChartPageModContentFactoryImpl.
 */
@Component
public final class PartyCoalitionsAgainstAnnualSummaryChartPageModContentFactoryImpl extends AbstractPartyPageModContentFactoryImpl {
	 ...
	 * impl.
	 */
	public PartyCoalitionsAgainstAnnualSummaryChartPageModContentFactoryImpl() {
		super();
	}
	...
	public Layout createContent(final String parameters, final MenuBar menuBar, final Panel panel) {
		...
		CardInfoRowUtil.createPageHeader(panel, panelContent, "Party Coalitions Against " + viewRiksdagenParty.getPartyName(), "Party Coalitions", "Review the summary of party coalitions against the selected party.");
	...
	public boolean matches(final String page, final String parameters) {
		return PageCommandPartyConstants.COMMAND_PARTY_AGAINST_COALITIONS_SUMMARY.matches(page, parameters);
	}
