...
public abstract class AbstractView extends Panel implements View {
	...
	protected final void createBasicLayoutWithPanelAndFooter(final String panelName) {
		...
		final Link spdxLink = new Link("SBOM(spdx)", new ExternalResource("https://repo1.maven.org/maven2/com/hack23/cia/citizen-intelligence-agency/2022.9.10/citizen-intelligence-agency-2022.9.10.spdx.rdf.xml"));
		final Link cyclonedxLink = new Link("SBOM(cyclonedx)", new ExternalResource("https://repo1.maven.org/maven2/com/hack23/cia/citizen-intelligence-agency/2022.9.10/citizen-intelligence-agency-2022.9.10-cyclonedx.json"));
