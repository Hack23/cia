...
public final class MinistryRankingMenuItemFactoryImpl extends AbstractMenuItemFactoryImpl
	...
	public void createMinistryRankingTopics(final MenuItem ministryMenuItem) {
		...
		chartByTopic.addItem(ALL_PARTIES_TOTAL_DAYS_SERVED_IN_MINISTRIES, VaadinIcons.CALENDAR,
				COMMAND_CHARTS_ALL_PARTIES_BY_HEADCOUNT);

		chartByTopic.addItem(ALL_MINISTRIES_TOTAL_MEMBERS, VaadinIcons.USER,
				COMMAND_CHARTS_ALL_MINISTRIES_BY_HEADCOUNT);

		chartByTopic.addItem(GOVERNMENT_ROLES_CHART, VaadinIcons.BAR_CHART,
				PageCommandMinistryRankingConstants.COMMAND_CHARTS_ALL_GOVERNMENT_ROLE_GANTT);
	...
	public void createOverviewPage(final VerticalLayout panelContent) {
		...
		createButtonLink(grid, GOVERNMENT_BODIES_INCOME, VaadinIcons.MONEY,
				PageCommandGovernmentBodyRankingConstants.COMMAND_GOVERNMENT_BODIES_INCOME,
		...
		createButtonLink(grid, GOVERNMENT_OUTCOME, VaadinIcons.BAR_CHART,
				PageCommandGovernmentBodyRankingConstants.COMMAND_GOVERNMENT_OUTCOME, GOVERNMENT_OUTCOME_DESCRIPTION);

		createButtonLink(grid, GOVERNMENT_ROLES_CHART, VaadinIcons.LINE_CHART,
				PageCommandGovernmentBodyRankingConstants.COMMAND_CHARTS_ALL_GOVERNMENT_ROLE_GANTT,
				GOVERNMENT_ROLES_CHART_DESCRIPTION);

		createButtonLink(grid, CURRENT_MINISTRIES_CURRENT_MEMBERS_TEXT, VaadinIcons.USERS,
				COMMAND_CHARTS_CURRENT_MINISTRIES_BY_HEADCOUNT, CURRENT_COMMITTEES_CURRENT_MEMBERS_DESCRIPTION);
