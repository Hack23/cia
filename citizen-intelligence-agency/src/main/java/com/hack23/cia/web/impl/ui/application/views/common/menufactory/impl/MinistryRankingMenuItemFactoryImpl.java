...
public final class MinistryRankingMenuItemFactoryImpl extends AbstractMenuItemFactoryImpl
	...
	public void createMinistryRankingTopics(final MenuItem ministryMenuItem) {
		...
		chartByTopic.addItem(GOVERNMENT_ROLES_CHART, VaadinIcons.GANTT, COMMAND_CHARTS_ALL_GOVERNMENT_ROLE_GANTT);

		ministryMenuItem.addItem(PAGE_VISIT_HISTORY_TEXT, VaadinIcons.HISTORY, COMMAND_PAGEVISITHISTORY);
	...
	public void createOverviewPage(final VerticalLayout panelContent) {
		...
		createButtonLink(grid, POLITICAL_WORK_SUMMARY_TEXT, VaadinIcons.BAR_CHART, COMMAND_DATAGRID, POLITICAL_WORK_SUMMARY_DESCRIPTION);
		...
		createButtonLink(grid,GOVERNMENT_ROLES_CHART, VaadinIcons.GANTT, COMMAND_CHARTS_ALL_GOVERNMENT_ROLE_GANTT, GOVERNMENT_ROLES_CHART_DESCRIPTION);
