...
public final class MinistryRankingMenuItemFactoryImpl extends AbstractMenuItemFactoryImpl
		implements MinistryRankingMenuItemFactory, MenuItemConstants {
	...
	public void createMinistryRankingTopics(final MenuItem ministryMenuItem) {
		...
		final MenuItem listItem = ministryMenuItem.addItem(POLITICAL_WORK_SUMMARY_TEXT, VaadinIcons.BAR_CHART, COMMAND_MINISTRY_RANKING_DATAGRID);
		...
		chartByTopic.addItem(GOVERNMENT_BODIES_EXPENDITURE, VaadinIcons.MONEY_WITHDRAW, COMMAND_GOVERNMENT_BODIES_EXPENDITURE);
		...
		chartByTopic.addItem(CURRENT_PARTIES_ACTIVE_IN_MINISTRIES_CURRENT_ASSIGNMENTS, VaadinIcons.GROUP, COMMAND_CHARTS_CURRENT_PARTIES_BY_HEADCOUNT);

		chartByTopic.addItem(ALL_PARTIES_TOTAL_DAYS_SERVED_IN_MINISTRIES, VaadinIcons.CALENDAR, COMMAND_CHARTS_ALLMINISTRIES_BY_TOTAL_DAYS);

		chartByTopic.addItem(ALL_MINISTRIES_TOTAL_MEMBERS, VaadinIcons.USER, COMMAND_CHARTS_ALL_MINISTRIES_BY_HEADCOUNT);
	...
	public void createOverviewPage(final VerticalLayout panelContent) {
		...
		createButtonLink(grid, CURRENT_PARTIES_ACTIVE_IN_MINISTRIES_CURRENT_ASSIGNMENTS, VaadinIcons.GROUP, COMMAND_CHARTS_CURRENT_PARTIES_BY_HEADCOUNT,
				CURRENT_PARTIES_ACTIVE_IN_COMMITTEES_CURRENT_ASSIGNMENTS_DESCRIPTION);

		createButtonLink(grid, ALL_PARTIES_TOTAL_DAYS_SERVED_IN_MINISTRIES, VaadinIcons.CALENDAR, COMMAND_CHARTS_ALLMINISTRIES_BY_TOTAL_DAYS,
				CURRENT_PARTIES_ACTIVE_IN_COMMITTEES_TOTAL_DAYS_SERVED_IN_COMMITTEES_DESCRIPTION);
		createButtonLink(grid, ALL_MINISTRIES_TOTAL_MEMBERS, VaadinIcons.USER, COMMAND_CHARTS_ALL_MINISTRIES_BY_HEADCOUNT, ALL_COMMITTEES_TOTAL_MEMBERS_DESCRIPTION);
