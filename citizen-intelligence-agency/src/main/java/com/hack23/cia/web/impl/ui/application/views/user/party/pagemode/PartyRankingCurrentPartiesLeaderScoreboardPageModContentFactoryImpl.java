...
public final class PartyRankingCurrentPartiesLeaderScoreboardPageModContentFactoryImpl
	...
	public Layout createContent(final String parameters, final MenuBar menuBar, final Panel panel) {
		...
		final Map<String, ViewRiksdagenPolitician> politicianMap = PartyLeaderUtil.loadActivePoliticiansByPersonId(getApplicationManager());
		...
		for (final ViewRiksdagenPolitician leader : partyLeaders) {
			...
			final Panel cardPanel = PoliticianLeaderboardUtil.createLeaderCard(null, leader, ballotSummary, governmentBodyByMinistry, reportByMinistry, experienceSummary);
