...
public final class CommitteeDecisionFlowPageModContentFactoryImpl extends AbstractCommitteePageModContentFactoryImpl {
	...
	public Layout createContent(final String parameters, final MenuBar menuBar, final Panel panel) {
		...
		createPageHeader(panel, panelContent, "Committee Decision Flow", "Decision Flow", "Analyze decision-making processes within committees.");
		...
		final ComboBox<String> comboBox = new ComboBox<>("Select year", Collections.unmodifiableList(
				Arrays.asList("2023/24", "2022/23","2021/22","2020/21","2019/20","2018/19","2017/18", "2016/17", "2015/16", "2014/15", "2013/14", "2012/13", "2011/12", "2010/11")));
