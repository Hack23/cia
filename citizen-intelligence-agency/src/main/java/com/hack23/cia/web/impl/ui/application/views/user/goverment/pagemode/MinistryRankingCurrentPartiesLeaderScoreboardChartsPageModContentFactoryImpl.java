...
public final class MinistryRankingCurrentPartiesLeaderScoreboardChartsPageModContentFactoryImpl
	...
	public Layout createContent(final String parameters, final MenuBar menuBar, final Panel panel) {
		...
		final Map<String, List<ViewRiksdagenPolitician>> activePoliticianMap = PartyLeaderUtil.loadActivePoliticiansByPersonId(getApplicationManager());
		...
		for (final ViewRiksdagenGovermentRoleMember govMember : activeGovMembers) {
			...
			final Panel cardPanel = PartyLeaderUtil.createLeaderCard(govMember, politician, ballotSummary, governmentBodyByMinistry,
