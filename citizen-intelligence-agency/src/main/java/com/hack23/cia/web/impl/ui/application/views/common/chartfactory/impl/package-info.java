 ...
 * - PartyGhantChartManagerImpl: Implementation of the PartyGhantChartManager interface.
 * - PartySupportsChartDataManagerImpl: Implementation of the PartySupportsChartDataManager interface.
 * - PersonDocumentChartDataManagerImpl: Implementation of the PersonDocumentChartDataManager interface.
 * - PoliticianDataManagerImpl: Implementation of the PoliticianDataManager interface.
 * - PoliticianGhantChartManagerImpl: Implementation of the PoliticianGhantChartManager interface.
 * - ViewRiksdagenVoteDataBallotPartySummaryChartDataManagerImpl: Implementation of the ViewRiksdagenVoteDataBallotPartySummaryChartDataManager interface.
