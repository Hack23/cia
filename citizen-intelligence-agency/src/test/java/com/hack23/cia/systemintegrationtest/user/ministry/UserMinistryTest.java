...
public final class UserMinistryTest extends AbstractUITest implements PageCommandUserConstants {
    ...
    @Test(timeout = DEFAULT_TIMEOUT)
    public void verifyAllRolesPage() throws Exception {
        pageVisit.visitDirectPage(PageCommandMinistryRankingConstants.COMMAND_CHARTS_ALL_GOVERNMENT_ROLES);
        pageVisit.verifyViewContent(
            MinistryRankingViewConstants.TITLE_MINISTRY_RANKINGS,
            MinistryRankingViewConstants.ALL_ROLES_TITLE,
            MinistryRankingViewConstants.ALL_ROLES_DESC);
        pageVisit.validatePage(PageCommandMinistryRankingConstants.COMMAND_CHARTS_ALL_GOVERNMENT_ROLES);
    }
