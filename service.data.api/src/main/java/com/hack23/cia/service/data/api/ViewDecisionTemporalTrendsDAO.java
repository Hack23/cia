 ...
 * 
 * Data access layer for decision temporal trends and patterns analysis.
 * 
 * @author intelligence-operative
 * @since v1.35 (Decision Intelligence)
 */
public interface ViewDecisionTemporalTrendsDAO
		extends
		AbstractGenericDAO<ViewDecisionTemporalTrends, Date> {
