 ...
 * 
 * Data access layer for individual politician decision pattern analysis.
 * 
 * @author intelligence-operative
 * @since v1.35 (Decision Intelligence)
 */
public interface ViewRiksdagenPoliticianDecisionPatternDAO
		extends
		AbstractGenericDAO<ViewRiksdagenPoliticianDecisionPattern, ViewRiksdagenPoliticianDecisionPatternEmbeddedId> {
	 ...
	 * @return the id list
	 */
	List<ViewRiksdagenPoliticianDecisionPatternEmbeddedId> getIdList();
}
