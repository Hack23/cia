...
/**
 * The Class SwedenPoliticalPartyDAOITest.
 */
public final class SwedenPoliticalPartyDAOITest extends AbstractServiceDataFunctionalIntegrationTest {
	...
	public void getIdListTest() throws Exception {
		assertFalse("Expect some party in database",swedenPoliticalPartyDAO.getIdList().isEmpty());
	}
