 ...
 *
 *	$Id: AbstractServiceDataFunctionalIntegrationTest.java 6046 2015-05-06 20:42:53Z pether $
 *  $HeadURL: svn+ssh://svn.code.sf.net/p/cia/code/trunk/service.data.impl/src/test/java/com/hack23/cia/service/data/impl/AbstractServiceDataFunctionalIntegrationTest.java $
 */
...
public abstract class AbstractServiceDataFunctionalIntegrationTest extends AbstractFunctionalIntegrationTest {

	/**
	 * Instantiates a new abstract riksdagen functional integration test.
	 */
	public AbstractServiceDataFunctionalIntegrationTest() {
		super();
	}
