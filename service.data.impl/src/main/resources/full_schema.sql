...
\restrict 7DIyZXbxkNay6RV95E1pvacNBXrAWgc5Wf53ew6crgJfT47jC4qR55qM1hjephf
...
CREATE VIEW public.view_riksdagen_party_coalition_evolution AS
 ...
 SELECT party_1 AS party_a,
    ...
    (alignment_rate - prev_semester_alignment) AS alignment_change,
    prev_semester_ballots,
    next_semester_ballots,
    (joint_ballots - prev_semester_ballots) AS ballot_change,
        CASE
            WHEN (alignment_rate >= (80)::numeric) THEN 'VERY_STRONG_COALITION'::text
            WHEN (alignment_rate >= (60)::numeric) THEN 'STRONG_COALITION'::text
            WHEN (alignment_rate >= (40)::numeric) THEN 'MODERATE_COALITION'::text
            WHEN (alignment_rate >= (20)::numeric) THEN 'WEAK_COALITION'::text
            ELSE 'MINIMAL_COALITION'::text
        END AS coalition_strength,
        CASE
            WHEN (vote_divergence_stddev <= (10)::numeric) THEN 'HIGHLY_STABLE'::text
            WHEN (vote_divergence_stddev <= (20)::numeric) THEN 'STABLE'::text
            WHEN (vote_divergence_stddev <= (30)::numeric) THEN 'MODERATELY_STABLE'::text
            ELSE 'VOLATILE'::text
        END AS coalition_stability,
        CASE
            WHEN ((alignment_rate - prev_semester_alignment) >= (20)::numeric) THEN 'STRENGTHENING_RAPIDLY'::text
            WHEN ((alignment_rate - prev_semester_alignment) >= (10)::numeric) THEN 'STRENGTHENING'::text
            WHEN (abs((alignment_rate - prev_semester_alignment)) < (10)::numeric) THEN 'STABLE'::text
            WHEN ((alignment_rate - prev_semester_alignment) <= ('-10'::integer)::numeric) THEN 'WEAKENING'::text
            WHEN ((alignment_rate - prev_semester_alignment) <= ('-20'::integer)::numeric) THEN 'WEAKENING_RAPIDLY'::text
            ELSE 'UNKNOWN'::text
        END AS coalition_momentum,
        CASE
            WHEN ((rank_by_alignment <= 3) AND ((alignment_rate - prev_semester_alignment) >= (15)::numeric)) THEN 'EMERGING_COALITION'::text
            WHEN ((rank_by_alignment <= 3) AND ((alignment_rate - prev_semester_alignment) <= ('-15'::integer)::numeric)) THEN 'FRACTURING_COALITION'::text
            WHEN ((alignment_rate >= (70)::numeric) AND ((joint_ballots - prev_semester_ballots) >= (50)::numeric)) THEN 'INTENSIFYING_COOPERATION'::text
            WHEN ((alignment_rate >= (70)::numeric) AND ((joint_ballots - prev_semester_ballots) <= ('-50'::integer)::numeric)) THEN 'DECLINING_COOPERATION'::text
            ELSE 'NORMAL'::text
...
CREATE VIEW public.view_riksdagen_party_electoral_trends AS
 WITH election_cycle_periods AS (
         ...
         SELECT ecp.election_cycle_id,
            ...
            round(stddev_pop(((100)::numeric - vbps.party_percentage_absent)), 2) AS participation_consistency
           FROM (election_cycle_periods ecp
         ...
         SELECT psp.election_cycle_id,
            ...
            psp.ballots_won,
            psp.win_rate,
            psp.avg_yes_percentage,
            psp.avg_no_percentage,
            psp.participation_rate,
            psp.yes_vote_consistency,
            psp.participation_consistency,
            round(((psp.win_rate / 100.0) * (349)::numeric), 0) AS seat_count_proxy,
            ...
            lag(round(((psp.win_rate / 100.0) * (349)::numeric), 0), 1) OVER (PARTITION BY psp.party ORDER BY psp.election_cycle_id, psp.cycle_year, psp.semester) AS prev_semester_seats,
            lead(round(((psp.win_rate / 100.0) * (349)::numeric), 0), 1) OVER (PARTITION BY psp.party ORDER BY psp.election_cycle_id, psp.cycle_year, psp.semester) AS next_semester_seats,
            ...
            rank() OVER (PARTITION BY psp.election_cycle_id, psp.semester ORDER BY psp.avg_no_percentage) AS rank_by_discipline,
 ...
 SELECT party,
    ...
    (win_rate - prev_semester_win_rate) AS win_rate_change,
    prev_semester_participation,
    next_semester_participation,
    (participation_rate - prev_semester_participation) AS participation_change,
    cycle_avg_win_rate,
    cycle_avg_participation,
    cycle_win_rate_volatility,
    (win_rate - cycle_avg_win_rate) AS deviation_from_cycle_avg,
        CASE
            WHEN (win_rate >= (30)::numeric) THEN 'DOMINANT'::text
            WHEN (win_rate >= (20)::numeric) THEN 'STRONG'::text
            WHEN (win_rate >= (10)::numeric) THEN 'COMPETITIVE'::text
            WHEN (win_rate >= (5)::numeric) THEN 'MINOR'::text
            ELSE 'MARGINAL'::text
        END AS electoral_performance,
        CASE
            WHEN ((win_rate - prev_semester_win_rate) >= (5)::numeric) THEN 'SURGING'::text
            WHEN ((win_rate - prev_semester_win_rate) >= (2)::numeric) THEN 'RISING'::text
            WHEN (abs((win_rate - prev_semester_win_rate)) < (2)::numeric) THEN 'STABLE'::text
            WHEN ((win_rate - prev_semester_win_rate) <= ('-2'::integer)::numeric) THEN 'DECLINING'::text
            WHEN ((win_rate - prev_semester_win_rate) <= ('-5'::integer)::numeric) THEN 'COLLAPSING'::text
            ELSE 'UNKNOWN'::text
        END AS electoral_momentum,
        CASE
            WHEN (avg_no_percentage <= (10)::numeric) THEN 'HIGHLY_DISCIPLINED'::text
            WHEN (avg_no_percentage <= (20)::numeric) THEN 'DISCIPLINED'::text
            WHEN (avg_no_percentage <= (30)::numeric) THEN 'MODERATELY_DISCIPLINED'::text
            ELSE 'LOW_DISCIPLINE'::text
        END AS party_discipline,
        CASE
            WHEN (participation_rate >= (95)::numeric) THEN 'VERY_HIGH_ENGAGEMENT'::text
            WHEN (participation_rate >= (85)::numeric) THEN 'HIGH_ENGAGEMENT'::text
            WHEN (participation_rate >= (75)::numeric) THEN 'MODERATE_ENGAGEMENT'::text
            ELSE 'LOW_ENGAGEMENT'::text
        END AS engagement_level,
        CASE
            WHEN (cycle_win_rate_volatility <= (2)::numeric) THEN 'HIGHLY_STABLE'::text
            WHEN (cycle_win_rate_volatility <= (5)::numeric) THEN 'STABLE'::text
            WHEN (cycle_win_rate_volatility <= (10)::numeric) THEN 'MODERATELY_VOLATILE'::text
            ELSE 'HIGHLY_VOLATILE'::text
        END AS performance_stability,
        CASE
            WHEN (next_semester_seats IS NOT NULL) THEN round(((next_semester_seats - prev_semester_seats) / 2.0), 1)
            WHEN (prev_semester_seats IS NOT NULL) THEN round((seat_count_proxy - prev_semester_seats), 1)
            ELSE NULL::numeric
        END AS projected_seat_change,
        CASE
            WHEN (seat_count_proxy < (prev_semester_seats - (10)::numeric)) THEN 'CRITICAL_SEAT_LOSS'::text
            WHEN (seat_count_proxy < (prev_semester_seats - (5)::numeric)) THEN 'SIGNIFICANT_SEAT_LOSS'::text
...
--
-- Name: idx_assignment_data_list_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_assignment_data_list_fk ON public.assignment_data USING btree (assignment_list_person_assig_0);
...
--
-- Name: idx_assignment_element_uppdrag_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_assignment_element_uppdrag_fk ON public.assignment_element USING btree (uppdrag_person_assignment_el_0);
...
--
-- Name: idx_committee_proposal_against_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_committee_proposal_against_fk ON public.committee_proposal_component_0 USING btree (against_proposal_container_c_0);


--
-- Name: idx_committee_proposal_container_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_committee_proposal_container_fk ON public.committee_proposal_component_0 USING btree (committee_proposal_container_0);


--
-- Name: idx_committee_proposal_document_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_committee_proposal_document_fk ON public.committee_proposal_component_0 USING btree (document_committee_proposal__0);


--
-- Name: idx_committee_proposal_list_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_committee_proposal_list_fk ON public.committee_proposal_data USING btree (committee_proposal_list_comm_0);
...
--
-- Name: idx_doc_activity_list_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_activity_list_fk ON public.document_activity_data USING btree (document_activities_document_0);


--
-- Name: idx_doc_attachment_list_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_attachment_list_fk ON public.document_attachment USING btree (document_attachment_list_doc_0);
...
--
-- Name: idx_doc_detail_list_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_detail_list_fk ON public.document_detail_data USING btree (document_detail_list_documen_0);


--
-- Name: idx_doc_element_container_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_element_container_fk ON public.document_element USING btree (dokument_document_container__0);


--
-- Name: idx_doc_person_ref_list_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_person_ref_list_fk ON public.document_person_reference_da_0 USING btree (document_person_reference_li_1);
...
--
-- Name: idx_doc_proposal_container_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_proposal_container_fk ON public.document_proposal_container USING btree (proposal_document_proposal_c_0);
...
--
-- Name: idx_doc_reference_list_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_reference_list_fk ON public.document_reference_data USING btree (document_reference_list_docu_0);


--
-- Name: idx_doc_status_activity_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_status_activity_fk ON public.document_status_container USING btree (document_activity_container__0);


--
-- Name: idx_doc_status_attachment_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_status_attachment_fk ON public.document_status_container USING btree (document_attachment_containe_0);


--
-- Name: idx_doc_status_detail_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_status_detail_fk ON public.document_status_container USING btree (document_detail_container_do_0);


--
-- Name: idx_doc_status_document_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_status_document_fk ON public.document_status_container USING btree (document_document_status_con_0);


--
-- Name: idx_doc_status_person_ref_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_status_person_ref_fk ON public.document_status_container USING btree (document_person_reference_co_1);


--
-- Name: idx_doc_status_proposal_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_status_proposal_fk ON public.document_status_container USING btree (document_proposal_document_s_0);


--
-- Name: idx_doc_status_reference_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_doc_status_reference_fk ON public.document_status_container USING btree (document_reference_container_0);
...
--
-- Name: idx_person_container_person_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_person_container_person_fk ON public.person_container_data USING btree (person_person_container_data_0);


--
-- Name: idx_person_data_assignment_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_person_data_assignment_fk ON public.person_data USING btree (person_assignment_data_perso_0);


--
-- Name: idx_person_data_detail_fk; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_person_detail_element_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_person_detail_element_fk ON public.person_detail_element USING btree (detail_list_person_detail_el_0);


--
-- Name: idx_person_element_assignment_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_person_element_assignment_fk ON public.person_element USING btree (person_assignment_element_pe_0);


--
-- Name: idx_person_element_container_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_person_element_container_fk ON public.person_element USING btree (person_person_container_elem_0);


--
-- Name: idx_person_element_detail_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_person_element_detail_fk ON public.person_element USING btree (person_detail_element_person_0);
...
--
-- Name: idx_sweden_party_region_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sweden_party_region_fk ON public.sweden_political_party USING btree (parties_sweden_election_regi_0);


--
-- Name: idx_vote_data_aggregation_cover; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_vote_data_aggregation_cover ON public.vote_data USING btree (vote_date, party, vote) INCLUDE (embedded_id_ballot_id, embedded_id_intressent_id) WHERE ((vote_date IS NOT NULL) AND (party IS NOT NULL));


--
-- Name: idx_vote_data_ballot_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_vote_data_ballot_date ON public.vote_data USING btree (embedded_id_ballot_id, vote_date);
...
--
-- Name: idx_vote_data_party_date; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_vote_data_party_date ON public.vote_data USING btree (party, vote_date);
...
CREATE INDEX idx_vote_data_politician_date ON public.vote_data USING btree (embedded_id_intressent_id, vote_date);
...
\unrestrict 7DIyZXbxkNay6RV95E1pvacNBXrAWgc5Wf53ew6crgJfT47jC4qR55qM1hjephf

--
-- PostgreSQL database dump
--

\restrict 7bst4V1yMrIAtRZFjG5p4OCNgUxASzHzjZqLhumDbh7C6SCVmLevBau43glTigj
...
1.64-intro	performance-engineer	db-changelog-1.64.xml	2026-01-23 02:12:36.897328	570	EXECUTED	9:placeholder	sql	Database Changelog v1.64 - Temporal Analysis Performance Indexes	\N	5.0.1	\N	\N	9132296214
...
1.64-001-idx-vote-data-ballot-date	performance-engineer	db-changelog-1.64.xml	2026-01-23 02:12:36.897328	571	EXECUTED	9:placeholder	createIndex indexName=idx_vote_data_ballot_date, tableName=vote_data	Create composite index on vote_data (ballot_id, vote_date)	\N	5.0.1	\N	\N	9132296214
1.64-002-idx-vote-data-party-date	performance-engineer	db-changelog-1.64.xml	2026-01-23 02:12:36.897328	572	EXECUTED	9:placeholder	createIndex indexName=idx_vote_data_party_date, tableName=vote_data	Create composite index on vote_data (party, vote_date)	\N	5.0.1	\N	\N	9132296214
1.64-003-idx-vote-data-politician-date	performance-engineer	db-changelog-1.64.xml	2026-01-23 02:12:36.897328	573	EXECUTED	9:placeholder	createIndex indexName=idx_vote_data_politician_date, tableName=vote_data	Create composite index on vote_data (intressent_id, vote_date)	\N	5.0.1	\N	\N	9132296214
1.64-004-idx-vote-data-aggregation-cover	performance-engineer	db-changelog-1.64.xml	2026-01-23 02:12:36.897328	574	EXECUTED	9:placeholder	sql	Create covering index on vote_data for temporal aggregations	\N	5.0.1	\N	\N	9132296214
1.64-999-verification	performance-engineer	db-changelog-1.64.xml	2026-01-23 02:12:36.897328	575	EXECUTED	9:placeholder	sql	Verification queries for temporal analysis performance indexes	\N	5.0.1	\N	\N	9132296214
\.
...
\unrestrict 7bst4V1yMrIAtRZFjG5p4OCNgUxASzHzjZqLhumDbh7C6SCVmLevBau43glTigj
