...
\restrict o1s2LXWumMTrugBARaaRc1yHnrHQDO8oZTaxBdkeYzh1OFwdeTdRB6a2yneYHvt
...
--
-- Name: view_election_cycle_temporal_trends_test; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.view_election_cycle_temporal_trends_test AS
 WITH v151_base AS (
         WITH election_cycle_calendar AS (
                 SELECT year_series.year_series AS calendar_year,
                    (((1994)::numeric + (floor((((year_series.year_series - 1994))::numeric / 4.0)) * (4)::numeric)))::integer AS cycle_start_year,
        ...
        UNION ALL
         ...
         SELECT v151.election_cycle_id,
            v151.cycle_year,
            v151.calendar_year,
            v151.semester,
            v151.is_pre_election_semester,
            v151.months_until_election,
            v151.active_politicians,
            v151.avg_attendance_rate,
            v151.total_ballots,
            v151.total_votes,
            v151.avg_win_rate,
            v151.avg_rebel_rate,
            v151.violation_count,
            v151.avg_ma_absence,
            v151.avg_approval_rate,
            v151.total_decisions,
            v151.avg_committee_productivity,
...
\unrestrict o1s2LXWumMTrugBARaaRc1yHnrHQDO8oZTaxBdkeYzh1OFwdeTdRB6a2yneYHvt

--
-- PostgreSQL database dump
--

\restrict 8A93YJJd8AIjaFIwm7OmLNG4WYKzl07aW3PsSLFugiMDA4u0fpQMjVvX6WKMad9
...
\unrestrict 8A93YJJd8AIjaFIwm7OmLNG4WYKzl07aW3PsSLFugiMDA4u0fpQMjVvX6WKMad9
