...
--
-- Purpose:
--   Analyzes the dependency graph for all materialized views in the database,
--   showing which views depend on which tables and other views.
--   Includes topological sorting to show refresh order.
--
-- Usage:
...
--
-- Output:
--   1. Basic dependency report (CSV format)
--   2. Dependency level analysis with refresh order

\echo 'Generating view dependency analysis...'
\echo ''
\echo '=== Part 1: Basic View Dependencies ==='
\echo ''
