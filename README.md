...
1. docker run hack23/cia:2021.12.21 -p 28443:8443
...
```
$ wget https://oss.sonatype.org/content/repositories/releases/com/hack23/cia/cia-dist-deb/2021.12.21/cia-dist-deb-2021.12.21.deb
```
...
```
$ sudo dpkg -i cia-dist-deb-2021.12.21.deb
```
