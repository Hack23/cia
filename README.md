...
1. docker run hack23/cia:2022.4.20 -p 28443:8443
...
```
$ wget https://oss.sonatype.org/content/repositories/releases/com/hack23/cia/cia-dist-deb/2022.4.20/cia-dist-deb-2022.4.20.deb
```
...
```
$ sudo dpkg -i cia-dist-deb-2022.4.20.deb
```
