...
[![JDK-15](https://img.shields.io/badge/jdk-15-orange.svg)]
[![JDK-16](https://img.shields.io/badge/jdk-16-red.svg)]
...
```
$ wget https://oss.sonatype.org/content/repositories/releases/com/hack23/cia/cia-dist-deb/2020.2.9/cia-dist-deb-2020.2.9.deb
```
...
```
$ sudo dpkg -i cia-dist-deb-2020.2.9.deb
```
