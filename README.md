...
|---------------------------|----------------------------------------------------------------------------------------------------------------------------------------------|
| **Core Framework**        | [Spring Framework](https://spring.io/projects/spring-framework) - Foundation for dependency injection and component management                |
| **Security**              | [Spring Security](https://spring.io/projects/spring-security), [Bouncy Castle](https://www.bouncycastle.org/) - Authentication and encryption |
| **Data Access**           | [Hibernate/JPA](https://hibernate.org/), [PostgreSQL](https://www.postgresql.org/) - ORM and database storage                                |
| **Transaction Management**| [Narayana](https://narayana.io/) - Integrated with Spring's JpaTransactionManager for distributed transaction support                        |
| **Data Auditing**         | [Javers](https://javers.org/) - Audit and version tracking for application data                                                              |
| **Business Rules Engine** | [Drools](https://www.drools.org/) - Rules processing and decision management                                                                 |
| **Messaging**             | [ActiveMQ Artemis](https://activemq.apache.org/components/artemis/), [Spring JMS](https://spring.io/) - Asynchronous event processing       |
| **Web/UI Layer**          | [Vaadin](https://vaadin.com/) - Server-driven UI with rich component model                                                                   |
| **Monitoring**            | [JavaMelody](https://github.com/javamelody/javamelody), [AWS CloudWatch](https://aws.amazon.com/cloudwatch/) - Performance tracking         |
| **Testing**               | [JUnit](https://junit.org/), [Mockito](https://site.mockito.org/), [Spring Test](https://spring.io/), [Selenium](https://www.selenium.dev/) |
| **Build & Dependency**    | [Maven](https://maven.apache.org/) - Project build, dependency management, and modular configuration                                         |
...
| **Category**                  | **AWS Services**                                     | **Security Framework Alignment**                              |
|-------------------------------|------------------------------------------------------|--------------------------------------------------------------|
| **Networking and Security**   | [VPC](https://aws.amazon.com/vpc/), [WAF](https://aws.amazon.com/waf/), [IAM](https://aws.amazon.com/iam/), [KMS](https://aws.amazon.com/kms/) | NIST CSF (ID.AM-2, PR.AC, PR.DS) & ISO 27001 (A.8.1, A.9.4.1) |
| **Domain & SSL Management**   | [Route 53](https://aws.amazon.com/route53/), [ACM](https://aws.amazon.com/certificate-manager/) | NIST CSF (PR.DS-5, DE.AE-3) & ISO 27001 (A.10.1.1) |
| **Compute & Load Balancing**  | [EC2](https://aws.amazon.com/ec2/), [ALB](https://aws.amazon.com/elasticloadbalancing/) | NIST CSF (PR.PT-1, PR.PT-3) & ISO 27001 (A.12.1.3, A.13.1.1) |
| **Data Storage**              | [S3](https://aws.amazon.com/s3/), [RDS](https://aws.amazon.com/rds/) (PostgreSQL) | NIST CSF (PR.DS-1, PR.DS-5) & ISO 27001 (A.8.2.3, A.10.1.1) |
| **Secrets & Monitoring**      | [Secrets Manager](https://aws.amazon.com/secrets-manager/), [CloudWatch](https://aws.amazon.com/cloudwatch/) | NIST CSF (PR.AC-1, DE.CM-3) & ISO 27001 (A.9.2.2, A.12.4.1) |
| **Resilience & Automation**   | [Resilience Hub](https://aws.amazon.com/resilience-hub/), [Systems Manager](https://aws.amazon.com/systems-manager/) | NIST CSF (RC.RP-1, PR.MA-1) & ISO 27001 (A.17.1.2, A.12.6.1) |
