...
```
$ wget https://oss.sonatype.org/content/repositories/releases/com/hack23/cia/cia-dist-deb/2018.4.300/cia-dist-deb-2018.4.300.deb
```
...
```
$ sudo dpkg -i cia-dist-deb-2018.4.300.deb
```
