...
```
$ wget https://oss.sonatype.org/content/repositories/releases/com/hack23/cia/cia-dist-deb/2017.11.12/cia-dist-deb-2017.11.12.deb
```
...
```
$ sudo dpkg -i cia-dist-deb-2017.11.12.deb
```
