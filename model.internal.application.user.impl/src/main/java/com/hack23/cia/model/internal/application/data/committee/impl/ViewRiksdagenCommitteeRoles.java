...
/**
 * The Class ViewRiksdagenCommitteeRoles.
 * 
 * JPA Entity for view_riksdagen_committee_roles database view.
 * 
 * Aggregates committee role assignments showing role types, assignment counts,
 * and temporal ranges for committee membership analysis.
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ViewRiksdagenCommitteeRoles", propOrder = {
    "embeddedId",
    "totalAssignments",
    "firstAssignmentDate",
    "lastAssignmentDate"
})
@Entity(name = "ViewRiksdagenCommitteeRoles")
@Table(name = "view_riksdagen_committee_roles")
@Inheritance(strategy = InheritanceType.JOINED)
public class ViewRiksdagenCommitteeRoles implements ModelObject {
    ...
    protected ViewRiksdagenCommitteeRolesEmbeddedId embeddedId;
     ...
     * @return the view riksdagen committee roles
     */
    public ViewRiksdagenCommitteeRoles withEmbeddedId(ViewRiksdagenCommitteeRolesEmbeddedId value) {
        setEmbeddedId(value);
        return this;
    }
     ...
     * @return the view riksdagen committee roles
     */
    public ViewRiksdagenCommitteeRoles withFirstAssignmentDate(Date value) {
     ...
     * @return the view riksdagen committee roles
     */
    public ViewRiksdagenCommitteeRoles withLastAssignmentDate(Date value) {
