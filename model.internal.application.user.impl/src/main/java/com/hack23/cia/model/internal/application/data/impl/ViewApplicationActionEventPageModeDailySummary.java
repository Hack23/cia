...
/**
 * <p>Java class for ViewApplicationActionEventPageModeDailySummary complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ViewApplicationActionEventPageModeDailySummary"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ViewApplicationActionEventPageModeDailySummary", propOrder = {
    "embeddedId",
    "hits",
    "rank",
    "rankPercentage"
})
@Entity(name = "ViewApplicationActionEventPageModeDailySummary")
@Table(name = "view_application_action_event_page_modes_daily_summary")
@Inheritance(strategy = InheritanceType.JOINED)
public class ViewApplicationActionEventPageModeDailySummary
    implements Serializable, ModelObject, Equals
{
    ...
    public ViewApplicationActionEventPageModeDailySummary withEmbeddedId(final ApplicationActionEventPageModePeriodSummaryEmbeddedId value) {
        setEmbeddedId(value);
        return this;
    }

    public ViewApplicationActionEventPageModeDailySummary withHits(final long value) {
        setHits(value);
        return this;
    }

    public ViewApplicationActionEventPageModeDailySummary withRank(final long value) {
        setRank(value);
        return this;
    }

    public ViewApplicationActionEventPageModeDailySummary withRankPercentage(final BigDecimal value) {
    ...
    public boolean equals(final ObjectLocator thisLocator, final ObjectLocator thatLocator, final Object object, final EqualsStrategy strategy) {
        ...
        final ViewApplicationActionEventPageModeDailySummary that = ((ViewApplicationActionEventPageModeDailySummary) object);
        {
