...
/**
 * <p>Java class for ViewApplicationActionEventPageAnnualSummary complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ViewApplicationActionEventPageAnnualSummary"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ViewApplicationActionEventPageAnnualSummary", propOrder = {
    "embeddedId",
    "hits",
    "rank",
    "rankPercentage"
})
@Entity(name = "ViewApplicationActionEventPageAnnualSummary")
@Table(name = "view_application_action_event_page_annual_summary")
@Inheritance(strategy = InheritanceType.JOINED)
public class ViewApplicationActionEventPageAnnualSummary
    implements Serializable, ModelObject, Equals
{
    ...
    public ViewApplicationActionEventPageAnnualSummary withEmbeddedId(final ApplicationActionEventPagePeriodSummaryEmbeddedId value) {
        setEmbeddedId(value);
        return this;
    }

    public ViewApplicationActionEventPageAnnualSummary withHits(final long value) {
        setHits(value);
        return this;
    }

    public ViewApplicationActionEventPageAnnualSummary withRank(final long value) {
        setRank(value);
        return this;
    }

    public ViewApplicationActionEventPageAnnualSummary withRankPercentage(final BigDecimal value) {
    ...
    public boolean equals(final ObjectLocator thisLocator, final ObjectLocator thatLocator, final Object object, final EqualsStrategy strategy) {
        ...
        final ViewApplicationActionEventPageAnnualSummary that = ((ViewApplicationActionEventPageAnnualSummary) object);
        {
            ApplicationActionEventPagePeriodSummaryEmbeddedId lhsEmbeddedId;
            lhsEmbeddedId = this.getEmbeddedId();
            ApplicationActionEventPagePeriodSummaryEmbeddedId rhsEmbeddedId;
