...
/**
 * <p>Java class for ViewApplicationActionEventPageDailySummary complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ViewApplicationActionEventPageDailySummary"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ViewApplicationActionEventPageDailySummary", propOrder = {
    "embeddedId",
    "hits",
    "rank",
    "rankPercentage"
})
@Entity(name = "ViewApplicationActionEventPageDailySummary")
@Table(name = "view_application_action_event_page_daily_summary")
@Inheritance(strategy = InheritanceType.JOINED)
public class ViewApplicationActionEventPageDailySummary
    implements ModelObject, Equals
{
    ...
    public ViewApplicationActionEventPageDailySummary withEmbeddedId(final ApplicationActionEventPagePeriodSummaryEmbeddedId value) {
        setEmbeddedId(value);
        return this;
    }

    public ViewApplicationActionEventPageDailySummary withHits(final long value) {
        setHits(value);
        return this;
    }

    public ViewApplicationActionEventPageDailySummary withRank(final long value) {
        setRank(value);
        return this;
    }

    public ViewApplicationActionEventPageDailySummary withRankPercentage(final BigDecimal value) {
    ...
    public boolean equals(final ObjectLocator thisLocator, final ObjectLocator thatLocator, final Object object, final EqualsStrategy strategy) {
        ...
        final ViewApplicationActionEventPageDailySummary that = ((ViewApplicationActionEventPageDailySummary) object);
        {
