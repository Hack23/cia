    ...
    implements Serializable, ModelObject, Equals
{
    ...
    public ViewApplicationActionEventPageModeHourlySummary withEmbeddedId(final ApplicationActionEventPageModePeriodSummaryEmbeddedId value) {
        setEmbeddedId(value);
        return this;
    }

    public ViewApplicationActionEventPageModeHourlySummary withHits(final long value) {
        setHits(value);
        return this;
    }

    public ViewApplicationActionEventPageModeHourlySummary withRank(final long value) {
        setRank(value);
        return this;
    }

    public ViewApplicationActionEventPageModeHourlySummary withRankPercentage(final BigDecimal value) {
