...
/**
 * <p>Java class for ViewApplicationActionEventPageModeAnnualSummary complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ViewApplicationActionEventPageModeAnnualSummary"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ViewApplicationActionEventPageModeAnnualSummary", propOrder = {
    "embeddedId",
    "hits",
    "rank",
    "rankPercentage"
})
@Entity(name = "ViewApplicationActionEventPageModeAnnualSummary")
@Table(name = "view_application_action_event_page_modes_annual_summary")
@Inheritance(strategy = InheritanceType.JOINED)
public class ViewApplicationActionEventPageModeAnnualSummary
    implements Serializable, ModelObject, Equals
{
    ...
    public ViewApplicationActionEventPageModeAnnualSummary withEmbeddedId(final ApplicationActionEventPageModePeriodSummaryEmbeddedId value) {
        setEmbeddedId(value);
        return this;
    }

    public ViewApplicationActionEventPageModeAnnualSummary withHits(final long value) {
        setHits(value);
        return this;
    }

    public ViewApplicationActionEventPageModeAnnualSummary withRank(final long value) {
        setRank(value);
        return this;
    }

    public ViewApplicationActionEventPageModeAnnualSummary withRankPercentage(final BigDecimal value) {
    ...
    public boolean equals(final ObjectLocator thisLocator, final ObjectLocator thatLocator, final Object object, final EqualsStrategy strategy) {
        ...
        final ViewApplicationActionEventPageModeAnnualSummary that = ((ViewApplicationActionEventPageModeAnnualSummary) object);
        {
