    ...
    implements Serializable, ModelObject, Equals
{
    ...
    public ViewApplicationActionEventPageElementWeeklySummary withEmbeddedId(final ApplicationActionEventPageElementPeriodSummaryEmbeddedId value) {
        setEmbeddedId(value);
        return this;
    }

    public ViewApplicationActionEventPageElementWeeklySummary withHits(final long value) {
        setHits(value);
        return this;
    }

    public ViewApplicationActionEventPageElementWeeklySummary withRank(final long value) {
        setRank(value);
        return this;
    }

    public ViewApplicationActionEventPageElementWeeklySummary withRankPercentage(final BigDecimal value) {
