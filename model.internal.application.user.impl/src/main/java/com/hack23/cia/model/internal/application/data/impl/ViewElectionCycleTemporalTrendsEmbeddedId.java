...
/**
 * The Class ViewElectionCycleTemporalTrendsEmbeddedId.
 * 
 * Composite key for election cycle temporal trends view.
 * 
 * @author intelligence-operative
 * @since v1.51 (Election Cycle Analytics)
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ViewElectionCycleTemporalTrendsEmbeddedId", propOrder = {
    "electionCycleId",
    "cycleYear",
    "semester"
})
@Embeddable
public class ViewElectionCycleTemporalTrendsEmbeddedId implements ModelObject {
	...
	@XmlElement(name = "cycle_year", required = true)
	 ...
	 * Sets the cycle year.
	 *
	 * @param value the new cycle year
	 */
