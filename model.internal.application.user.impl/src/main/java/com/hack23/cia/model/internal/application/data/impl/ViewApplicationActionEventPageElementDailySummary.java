...
/**
 * <p>Java class for ViewApplicationActionEventPageElementDailySummary complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ViewApplicationActionEventPageElementDailySummary"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ViewApplicationActionEventPageElementDailySummary", propOrder = {
    "embeddedId",
    "hits",
    "rank",
    "rankPercentage"
})
@Entity(name = "ViewApplicationActionEventPageElementDailySummary")
@Table(name = "view_application_action_event_page_element_daily_summary")
@Inheritance(strategy = InheritanceType.JOINED)
public class ViewApplicationActionEventPageElementDailySummary
    implements Serializable, ModelObject, Equals, HashCode, ToString
{
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "elementId", column = @Column(name = "EMBEDDED_ID_ELEMENT_ID", length = 255))
    })
    ...
    public ViewApplicationActionEventPageElementDailySummary withEmbeddedId(ApplicationActionEventPageElementPeriodSummaryEmbeddedId value) {
        setEmbeddedId(value);
        return this;
    }

    public ViewApplicationActionEventPageElementDailySummary withHits(long value) {
        setHits(value);
        return this;
    }

    public ViewApplicationActionEventPageElementDailySummary withRank(long value) {
        setRank(value);
        return this;
    }

    public ViewApplicationActionEventPageElementDailySummary withRankPercentage(BigDecimal value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ApplicationActionEventPageElementPeriodSummaryEmbeddedId theEmbeddedId;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final ViewApplicationActionEventPageElementDailySummary that = ((ViewApplicationActionEventPageElementDailySummary) object);
        {
