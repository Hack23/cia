    ...
    implements Serializable, ModelObject, Equals
{
    ...
    public ViewApplicationActionEventPageElementDailySummary withEmbeddedId(final ApplicationActionEventPageElementPeriodSummaryEmbeddedId value) {
        setEmbeddedId(value);
        return this;
    }

    public ViewApplicationActionEventPageElementDailySummary withHits(final long value) {
        setHits(value);
        return this;
    }

    public ViewApplicationActionEventPageElementDailySummary withRank(final long value) {
        setRank(value);
        return this;
    }

    public ViewApplicationActionEventPageElementDailySummary withRankPercentage(final BigDecimal value) {
