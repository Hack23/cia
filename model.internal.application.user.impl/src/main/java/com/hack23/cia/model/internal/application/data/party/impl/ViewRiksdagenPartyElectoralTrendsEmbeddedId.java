...
/**
 * The Class ViewRiksdagenPartyElectoralTrendsEmbeddedId.
 * Composite key for party electoral trends tracking (party + election_cycle_id + semester).
 */
@Embeddable
public class ViewRiksdagenPartyElectoralTrendsEmbeddedId implements Serializable {
	...
	/**
	 * Instantiates a new view riksdagen party electoral trends embedded id.
	 */
	public ViewRiksdagenPartyElectoralTrendsEmbeddedId() {
		super();
	}
