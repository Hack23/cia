...
/**
 * The Class WorldbankApiAgentWorkConsumerImplITest.
 */
public class WorldbankApiAgentWorkConsumerImplITest extends AbstractServiceComponentAgentFunctionalIntegrationTest {

	/** The messsage listener. */
	@Autowired
	@Qualifier("WorldBankApiAgentWorkConsumer")
