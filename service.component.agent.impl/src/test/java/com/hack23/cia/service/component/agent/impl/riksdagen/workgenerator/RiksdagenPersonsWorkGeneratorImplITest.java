...
/**
 * The Class RiksdagenPersonsWorkGeneratorImplITest.
 */
@Transactional
public class RiksdagenPersonsWorkGeneratorImplITest extends AbstractServiceComponentAgentFunctionalIntegrationTest {

	/** The riksdagen data sources work generator. */
	@Autowired
	@Qualifier("RiksdagenPersonsWorkGeneratorImpl")
