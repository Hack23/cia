...
/**
 * The Class RiksdagenDocumentContentWorkGeneratorImplITest.
 */
@Transactional
public class RiksdagenDocumentContentWorkGeneratorImplITest extends AbstractServiceComponentAgentFunctionalIntegrationTest {

	/** The riksdagen data sources work generator. */
	@Autowired
	@Qualifier("RiksdagenDocumentContentWorkGeneratorImpl")
	...
	public void generateWorkOrdersSuccessTest() throws JMSException {
		...
		verify(jmsSenderMock, times(4204)).send(destCaptor.capture(),stringCaptor.capture());
