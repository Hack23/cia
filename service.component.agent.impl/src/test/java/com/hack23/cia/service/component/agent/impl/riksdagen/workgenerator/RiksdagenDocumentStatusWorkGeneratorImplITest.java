...
/**
 * The Class RiksdagenDocumentStatusWorkGeneratorImplITest.
 */
@Transactional
public class RiksdagenDocumentStatusWorkGeneratorImplITest extends AbstractServiceComponentAgentFunctionalIntegrationTest {

	/** The riksdagen data sources work generator. */
	@Autowired
	@Qualifier("RiksdagenDocumentStatusWorkGeneratorImpl")
	...
	public void generateWorkOrdersSuccessTest() throws JMSException {
		...
		verify(jmsSenderMock, times(1180)).send(destCaptor.capture(),stringCaptor.capture());
