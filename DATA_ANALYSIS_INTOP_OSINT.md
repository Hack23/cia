...
**Detection Accuracy** (Historical Validation - Updated v1.61):
- **Pre-resignation detection**: 87% accuracy (73 cases, 8-month avg warning)
- **Coalition stress detection**: 78% accuracy (22 cases, 4-month avg warning) ✅ Enhanced with party longitudinal views
...
- **Politician risk profiles**: 89% comprehensive risk assessment ✅ Enhanced with career path integration
...
- [`view_riksdagen_q4_election_year_comparison`](DATABASE_VIEW_INTELLIGENCE_CATALOG.md#view_riksdagen_q4_election_year_comparison) - Q4 pre-election surge detection (>150% baseline), compares election year Q4 vs non-election Q4 patterns
...
- Enhanced use of RANK, PERCENT_RANK, NTILE for comparative rankings
- LAG/LEAD for temporal trend detection and year-over-year comparisons
- STDDEV_POP for volatility and anomaly detection
- AVG window functions for baseline calculations
